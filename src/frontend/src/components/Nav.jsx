...
export default function Nav({ onBackToDetect, onLogout, onTabChange, onTaskCenterClick, themeMode, effectiveTheme, onThemeModeChange }) {
  ...
  return (
    <nav className={s.nav}>
      <a className={s.brand} href="/">
        <img className={s.brandLockup} src="/lightscan-lockup.svg" alt="LightScan" />
      </a>
      ...
      <div className={s.right}>
        ...
        <NetStatus />
        <div className={s.divider} />
        <label className={s.themeSelectWrap} title={`当前：${THEME_LABELS[themeMode]} · 实际${effectiveTheme === 'dark' ? '深色' : '浅色'}`}>
          {effectiveTheme === 'dark' ? (
