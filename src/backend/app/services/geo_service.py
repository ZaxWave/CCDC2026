    ...
    try:
        ...
        if exif:
            ...
            if 'GPSLatitude' in geo_info and 'GPSLongitude' in geo_info:
                lat = _get_decimal_from_dms(geo_info['GPSLatitude'], geo_info['GPSLatitudeRef'])
                lng = _get_decimal_from_dms(geo_info['GPSLongitude'], geo_info['GPSLongitudeRef'])
                return lat, lng
    except Exception:
        pass
